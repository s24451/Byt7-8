...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		Integer add = amount + currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
	...
	public Money sub(Money other) {
        int totalAmount = this.amount - other.getCurrency().valueInThisCurrency(other.getAmount(), this.currency);
    ...
    public int compareTo(Object other) {
        if (!(other instanceof Money)) {
            throw new IllegalArgumentException("Argument must be an instance of Money");
        }
